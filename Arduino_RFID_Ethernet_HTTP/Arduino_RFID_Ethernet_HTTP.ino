...
char   HOST_NAME[] = "192.168.1.39"; // change to your PC's IP address
String PATH_NAME   = "/rfiddzikry/data-api.php";
String getData;
  ...
  //POST TO WEB
    ...
    while(client.connected()) {
      if(client.available()){
        ...
        //AMBIL DATA JSON
        const size_t capacity = JSON_OBJECT_SIZE(10) + 110; //cari dulu nilainya pakai Arduino Json 5 Asisten
